    ...
    html: `
      <div style="font-family:Georgia,serif;max-width:600px;margin:0 auto;background:#f5edd6;padding:0;border-top:4px solid #c9922a;">
        ...
        <div style="padding:1.5rem;background:#ffffff;border-bottom:1px solid #e8d9b5;">
          ...
          <p style="font-size:15px;color:#2c1f0e;line-height:1.85;margin:0 0 1.5rem;">Your first <strong>7 days are completely free</strong> — 10 Deep Analyses per month plus continuous eBay monitoring. Then just $9.99 a month. No contracts, no commitments — cancel anytime before day 8 and you won't be charged a penny.</p>
